...
1. 如果存在 `AGENTS.md`、`docs/dev/iteration-plan.md`、`docs/dev/requirements.md`、`docs/user/usage.md`、`docs/dev/roadmap.md`、`docs/dev/execution-plan.md`、`docs/dev/status-and-next-steps.md`，按需读取相关部分。
